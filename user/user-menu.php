    ...
    <header class="">
		<nav  class="mobile-nav navbar d-md-none navbar-light flex-column">
			<div id="side-nav" class="py-2 d-flex fixed-top w-100 px-3 green-bg paper-box-shadow">
				<a class="navbar-brand upper-case" href="./home.php" title="Go to Home Page">
					...
					<div class="side-menu bg-white d-flex flex-column px-3 ">
						...
						<ul class=" bg-white mt-4" id="links-li">
							<li class="nav-item px-xl-2 active">
								<a class="nav-link px-0 mt-2 border-top" href="home.php" > Home </a>
							</li>
							<li class="nav-item px-xl-2 active">
								<a class="nav-link px-0 mt-2 border-top"  href="../profile.php"> Account Profile </a>
							</li>
							<li class="nav-item px-xl-2 active">
								<a class="nav-link px-0 mt-2 border-top" href="../settings.php"> Settings </a>
							</li>
							<li class="nav-item px-xl-2 active">
								<a class="nav-link px-0 mt-2 border-top" href="../backends/logout.php"> Logout </a>
							</li>
						</ul>
            ...
            <div class="row">
                ...
                <aside class="col-md-3 d-sm-none d-md-block sidebar" id="side-nav">
                    ...
                    <ul class="nav-links" class="">
                        <li <?=$l1?> ><a class="d-block" href="home.php" > Home </a></li>
                        <li <?=$l6?> ><a class="d-block" href="../profile.php"> Account Profile </a></li>
                        <li <?=$l5?> ><a class="d-block" href="../settings.php"> Settings </a></li>   
                        <li <?=$l5?> ><a class="d-block" href="../backends/logout.php"> Logout </a></li>   
                    </ul>
                </aside>
                
                <main class="col-md-9 offset-md-3 col-xs-12" id="main-content">
                <?php
                    if($default_header) {
                ?>
                    <header>
	                    <nav aria-label="breadcrumb" role="navigation" class="row mb-3 pl-3">
	                      ...
	                      <div class="col d-flex align-items-center">
	                    	...
	                    	<a href="../backends/logout.php" class="btn btn-danger ml-auto d-none d-sm-inline-block"><b> Logout </b></a>
	                      </div>
	                    </nav>
                    </header>
                <?php
