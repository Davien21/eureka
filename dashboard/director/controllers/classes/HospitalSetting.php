<?php
	/**
	 * This Class is responsible for all hospital management on this App
	...
	class HospitalSetting extends DBConnect
	{
		...
		public function get_ids_for_hospitals_directed($user_id)	{
			...
			return $record = $check_query->fetchAll(parent::FETCH_ASSOC);
		}
		public function get_hospital_profile($hospital_id)	{
			...
			// echo print_r($check_query->errorInfo());
			return $record = $check_query->fetch(parent::FETCH_ASSOC);
		}
